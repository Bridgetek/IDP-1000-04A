...
static uint8_t FirstPage_ESD_Push_Button_Font__Property(void *context) { return 32; }
static uint8_t FirstPage_ESD_Toggle_Font__Property(void *context) { return 32; }
...
void FirstPage__ESD_Push_Button__Initializer(FirstPage *context)
{
	...
	object->Widget.LocalY = 220;
	object->Widget.LocalWidth = 262;
	object->Widget.LocalHeight = 114;
...
void FirstPage__ESD_Image_SlideShow__Initializer(FirstPage *context)
{
	...
	object->Owner = (void *)context;
	object->Widget.Active = 1;
	object->Widget.LocalX = 412;
	object->Widget.LocalY = 85;
	object->Widget.LocalWidth = 816;
	object->Widget.LocalHeight = 526;
	object->Speed = 3L;
